...
func (x *RegisterRequest) Reset() {
	*x = RegisterRequest{}
	mi := &file_sso_sso1_proto_msgTypes[0]
...
func (*RegisterRequest) Descriptor() ([]byte, []int) {
	return file_sso_sso1_proto_rawDescGZIP(), []int{0}
}
...
func (x *RegisterResponse) Reset() {
	*x = RegisterResponse{}
	mi := &file_sso_sso1_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*RegisterResponse) Descriptor() ([]byte, []int) {
	return file_sso_sso1_proto_rawDescGZIP(), []int{1}
}
...
func (x *LoginRequest) Reset() {
	*x = LoginRequest{}
	mi := &file_sso_sso1_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*LoginRequest) Descriptor() ([]byte, []int) {
	return file_sso_sso1_proto_rawDescGZIP(), []int{2}
}
...
func (x *LoginResponse) Reset() {
	*x = LoginResponse{}
	mi := &file_sso_sso1_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*LoginResponse) Descriptor() ([]byte, []int) {
	return file_sso_sso1_proto_rawDescGZIP(), []int{3}
}
...
var File_sso_sso1_proto protoreflect.FileDescriptor

var file_sso_sso1_proto_rawDesc = []byte{
	0x0a, 0x0e, 0x73, 0x73, 0x6f, 0x2f, 0x73, 0x73, 0x6f, 0x31, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	...
	0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x14, 0x5a,
...
var (
	file_sso_sso1_proto_rawDescOnce sync.Once
	file_sso_sso1_proto_rawDescData = file_sso_sso1_proto_rawDesc
)

func file_sso_sso1_proto_rawDescGZIP() []byte {
	file_sso_sso1_proto_rawDescOnce.Do(func() {
		file_sso_sso1_proto_rawDescData = protoimpl.X.CompressGZIP(file_sso_sso1_proto_rawDescData)
	})
	return file_sso_sso1_proto_rawDescData
}

var file_sso_sso1_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_sso_sso1_proto_goTypes = []any{
	(*RegisterRequest)(nil),  // 0: auth.RegisterRequest
	(*RegisterResponse)(nil), // 1: auth.RegisterResponse
	(*LoginRequest)(nil),     // 2: auth.LoginRequest
	(*LoginResponse)(nil),    // 3: auth.LoginResponse
}
var file_sso_sso1_proto_depIdxs = []int32{
...
func init() { file_sso_sso1_proto_init() }
func file_sso_sso1_proto_init() {
	if File_sso_sso1_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_sso_sso1_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_sso_sso1_proto_goTypes,
		DependencyIndexes: file_sso_sso1_proto_depIdxs,
		MessageInfos:      file_sso_sso1_proto_msgTypes,
	}.Build()
	File_sso_sso1_proto = out.File
	file_sso_sso1_proto_rawDesc = nil
	file_sso_sso1_proto_goTypes = nil
	file_sso_sso1_proto_depIdxs = nil
}
